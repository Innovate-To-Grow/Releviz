...
class MaintenanceBypassViewTest(TestCase):
    ...
    def test_not_in_maintenance_returns_400(self):
        ...
        response = self.client.post(
            self.URL, data={"password": "abc"}, content_type="application/json"
        )
    ...
    def test_wrong_password_returns_403(self):
        ...
        response = self.client.post(
            self.URL, data={"password": "wrong"}, content_type="application/json"
        )
    ...
    def test_correct_password_returns_200(self):
        ...
        response = self.client.post(
            self.URL, data={"password": "secret123"}, content_type="application/json"
        )
    ...
    def test_legacy_plaintext_password_still_works(self):
        ...
        response = self.client.post(
            self.URL, data={"password": "legacy-secret"}, content_type="application/json"
        )
