MODEL_MAP = {
    ...
    "CheckInRecord": ("event", "CheckInRecord"),
    "Project": ("projects", "Project"),
    "Semester": ("projects", "Semester"),
    "EmailCampaign": ("mail", "EmailCampaign"),
    "RecipientLog": ("mail", "RecipientLog"),
    "CMSPage": ("cms", "CMSPage"),
    "CMSBlock": ("cms", "CMSBlock"),
    "NewsArticle": ("cms", "NewsArticle"),
    "NewsFeedSource": ("cms", "NewsFeedSource"),
    "PageView": ("cms", "PageView"),
    "Menu": ("cms", "Menu"),
}
