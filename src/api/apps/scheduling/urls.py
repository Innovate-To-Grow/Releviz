...
urlpatterns = [
    ...
    path(
        ...
        views.RosterParticipantView.as_view(),
    ...
    path("events/stream", views.EventStreamView.as_view(), name="api-event-stream"),
