    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "days",
                    models.JSONField(default=apps.scheduling.models.events.event.default_weekdays),
                ),
                (
                    "mode",
                    models.CharField(
        ...
        migrations.AddIndex(
            model_name="eventinvitation",
            index=models.Index(fields=["first_sent_at"], name="scheduling__first_s_90998e_idx"),
        ),
        migrations.AddIndex(
            model_name="eventinvitation",
            index=models.Index(fields=["last_sent_at"], name="scheduling__last_se_af9ba0_idx"),
        ),
        migrations.AddIndex(
            model_name="eventinvitation",
            index=models.Index(fields=["reminder_sent_at"], name="scheduling__reminde_f174ad_idx"),
        ),
        migrations.AddConstraint(
            model_name="eventinvitation",
            constraint=models.UniqueConstraint(
