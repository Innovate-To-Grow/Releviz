      ...
      <main id="main" className="rv-page rv-page--prose">
        <article className="rv-stack rv-stack--xl">
          <header className="rv-page-header">
            ...
            <h1 className="rv-page-header__title">Terms of service</h1>
          ...
          <div className="rv-prose">
            <section>
              ...
              <p>
                Releviz is provided for coordinating meeting availability. Use
                the service lawfully, provide accurate account information,
                protect your credentials, and access only events you are
                authorized to use.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                meeting they confirm. Do not upload confidential information
                that is unnecessary for scheduling.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Do not probe or bypass access controls, abuse invitations or
                email delivery, interfere with service operation, impersonate
                another person, or use Releviz to distribute unlawful or harmful
                content.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                improve. Access can be limited to protect users or
                infrastructure. Scheduling and email delivery depend on external
                systems, so uninterrupted availability is not guaranteed.
              </p>
            </section>
